...
function calcularPuntaje(){
    var puntaje1 = 0;
    var puntaje2 = 0;
    var name1=document.getElementById("nombre").value.toLowerCase();
    var name2=document.getElementById("nombreRes").value.toLowerCase();
    var apellido1=document.getElementById("apellido").value.toLowerCase();
    var apellido2=document.getElementById("apellidoRes").value.toLowerCase();
    var ciudad1=document.getElementById("ciudad").value.toLowerCase();
    var ciudad2=document.getElementById("ciudadRes").value.toLowerCase();
    var alimento1=document.getElementById("alimento").value.toLowerCase();
    var alimento2=document.getElementById("alimentoRes").value.toLowerCase();
    var animal1=document.getElementById("animal").value.toLowerCase();
    var animal2=document.getElementById("animalRes").value.toLowerCase();
    var cosa1=document.getElementById("cosa").value.toLowerCase();
    var cosa2=document.getElementById("cosaRes").value.toLowerCase();
    var letra = document.getElementById("letra").value;
    if(name1 !== name2){
        if(name1 !== "" && name1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(name2 !== "" && name2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(name1===name2 && name1 !== "" && name1.startsWith(letra)){
        puntaje1 = puntaje1 + 50;
        puntaje2 = puntaje2 + 50;
    }
     
    if(apellido1 !== apellido2){
        if(apellido1 !== "" && apellido1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(apellido2 !== "" && apellido2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(apellido1===apellido2 && apellido1 !== "" &&apellido1.startsWith(letra)){
        puntaje1 = puntaje1 + 50;
        puntaje2 = puntaje2 + 50;
    }
     
    if(ciudad1 !== ciudad2){
        if(ciudad1 !== "" && ciudad1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(ciudad2 !== "" && ciudad2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(ciudad1===ciudad2 && ciudad1 !== "" && ciudad1.startsWith(letra)){
        puntaje1 = puntaje1 + 50;
        puntaje2 = puntaje2 + 50;
    }
     
    if(alimento1 !== alimento2){
        if(alimento1 !== "" && alimento1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(alimento2 !== "" && alimento2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(alimento1===alimento2 && alimento1 !== "" && alimento1.startsWith(letra)){
            puntaje1 = puntaje1 + 50;
            puntaje2 = puntaje2 + 50;
    }
     
    if(animal1 !== animal2){
        if(animal1 !== "" && animal1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(animal2 !== "" && animal2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(animal1===animal2 && animal1 !== "" && animal1.startsWith(letra)){
        puntaje1 = puntaje1 + 50;
        puntaje2 = puntaje2 + 50;
    }
     
    if(cosa1 !== cosa2){
        if(cosa1 !== "" && cosa1.startsWith(letra)){
            puntaje1 = puntaje1 + 100;
        }
        if(cosa2 !== "" && cosa2.startsWith(letra)){
            puntaje2 = puntaje2 + 100;
        }
    }
    else if(cosa1===cosa2 && cosa1 !== "" && cosa1.startsWith(letra)){
        puntaje1 = puntaje1 + 50;
        puntaje2 = puntaje2 + 50;
    }
